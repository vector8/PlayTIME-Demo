...
public class CameraControl : MonoBehaviour
{
    ...
    public GameObject staticFollowTarget = null;
    ...
    private void buttonReleasedHandler(object sender, EventArgs e)
    {
        ...
        if (s.name.Equals(targetBtn.name))
        {
            ...
            {
                setFollowTarget(targetBtn.transform.position);
            }
            else
            {
                followTarget = null;
                staticFollowTarget = null;
            }
    ...
    {
        followTarget = levelManager.getObjectAtPosition(position).first;
        staticFollowTarget = levelManager.getObjectAtPosition(position).second;
    }
